...
public class CafeMgr {
	...
	public CafeMgr() {
		...
		c1[cIndex] = new Coffee("아메리카노", 1200, 0, true, false);
		c2[cIndex++] = new Coffee("아메리카노", 1200, 100, true, false);
		c[cIndex] = new Coffee("아메리카노", 2500, 20, true, true);
		c1[cIndex] = new Coffee("아메리카노", 1200, 0, true, true);
		c2[cIndex++] = new Coffee("아메리카노", 1200, 100, true, true);

		c[cIndex] = new Coffee("카페라떼", 2500, 20, false, false);
		c1[cIndex] = new Coffee("카페라떼", 1200, 0, false, false);
		c2[cIndex++] = new Coffee("카페라떼", 1200, 100, false, false);
		c[cIndex] = new Coffee("카페라떼", 2500, 20, false, true);
		c1[cIndex] = new Coffee("카페라떼", 1200, 0, false, true);
		c2[cIndex++] = new Coffee("카페라떼", 1200, 100, false, true);
		...
		c1[cIndex] = new Coffee("카라멜마끼아또", 1700, 0, true, false);
		c2[cIndex++] = new Coffee("카라멜마끼아또", 1700, 100, true, false);
		c[cIndex] = new Coffee("카라멜마끼아또", 3500, 20, true, true);
		c1[cIndex] = new Coffee("카라멜마끼아또", 1700, 0, true, true);
		c2[cIndex++] = new Coffee("카라멜마끼아또", 1700, 100, true, true);
		...
		j1[jIndex] = new Juice("오렌지 주스", 1700, 0, true);
		j2[jIndex++] = new Juice("오렌지 주스", 1700, 100, true);
		...
		j1[jIndex] = new Juice("딸기 주스", 1700, 0, true);
		j2[jIndex++] = new Juice("딸기 주스", 1700, 100, true);
		...
		j1[jIndex] = new Juice("바나나 주스", 1700, 0, true);
		j2[jIndex++] = new Juice("바나나 주스", 1700, 100, true);
	...
	public void printCoffee() {
		...
		for (int i = 0; i < cIndex; i++) {
			String name = (c[i].getTemp() ? "아이스" : "뜨거운") + " " + c[i].getName() + " " + (c[i].getSize() ? "Large" : "Small") + "\t";
	...
	public void printDesert() {
		...
		for (int i = 0; i < dIndex; i++) {
			...
			System.out.println((i + 1) + "\t" + name + d[i].getPrice() + "\t" + d[i].getStock() + "\t" + d[i].getExpired());
		}
	}
