...
| [2.31](#231-31일차2020-03-20) | [2.32](#232-32일차2020-03-23) | [2.33](#233-33일차2020-03-24) | [2.34](#) | [2.35](#) | [2.36](#) | [2.37](#) | [2.38](#) | [2.39](#) | [2.40](#) |
...
- 하이퍼링크 태그
  - a 태그
    ...
    | 속성 | 설명 |  
    | :-----: | :-----: |  
    | href | 링크 페이지가 표시될 위치 지정(새창, 현재창) |  
    | target | 사진을 위해 개발<br>저장을 반복하다 보면 화질이 떨어질 수 있음 |  
...
- 폼 태그
  ...
  | 속성 | <center>설명</center> |  
  | :-----: | :----- |  
  | 메소드 | get : URL 창에 데이터를 보내는 방식<br>보내는 데이터 크기에 제한이 있음(256~4096byte)<br>보내는 데이터가 눈으로 보임<br>post : http 헤더에 데이터를 넣어 보내는 방식<br>보내는 데이터의 크기에 제한이 없음<br>보내는 데이터를 볼 수 없음 |  
  | name | form 태그의 고유 이름 지정 |  
  | action | 데이터를 처리할 프로그램(페이지) 지정 |  
  | target | action 속성을 어떻게 열것인지 결정 |  
  | type | 벡터 이미지로 최근 활용이 많이 된다. |  
