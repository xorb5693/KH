...
INSERT INTO M_TEST02 VALUES('user12', '사용자12');
INSERT INTO M_TEST02 VALUES('user22', '사용자22');
INSERT INTO M_TEST02 VALUES('user32', '사용자33');
...
WHEN MATCHED THEN --위의 ON이 TRUE면
UPDATE SET -- UPDATE 실행
M_TEST01.NAME = M_TEST02.NAME
WHEN NOT MATCHED THEN --위의 ON이 FALSE면
INSERT -- INSERT 실행
...
CREATE TABLE TEST02(
    ID VARCHAR2(20) REFERENCES TEST01(ID),
    TESTDATE DATE
);
...
--1. 제약조건 비활성화
ALTER TABLE TEST02
DISABLE CONSTRAINT SYS_C007084 CASCADE;
--2. 데이터 삭제
DELETE FROM TEST01 WHERE ID = 'USER02';
SELECT * FROM TEST02;
--3. 제약조건 활성화
ALTER TABLE TEST02
ENABLE CONSTRAINT SYS_C007084;
